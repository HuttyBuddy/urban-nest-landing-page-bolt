...
export default function Features() {
  ...
  return (
    <section id="features" className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24 bg-cream-100">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-lg sm:text-xl text-navy-400 max-w-3xl mx-auto leading-relaxed">
            While other agents waste hours creating content or settle for generic AI that sounds robotic, you'll have a complete marketing ecosystem with <span className="font-bold text-navy-600">hyper-local intelligence</span>, <span className="font-bold text-navy-600">Google AI power</span>, <span className="font-bold text-navy-600">brand customization</span>, <span className="font-bold text-navy-600">CRM integration</span>, <span className="font-bold text-navy-600">listing automation</span>, and <span className="font-bold text-navy-600">digital avatars</span>.
          </p>
        </div>

        <div className="mb-20 lg:mb-28">
          <h3 className="text-2xl sm:text-3xl font-extrabold text-navy-600 mb-4 text-center">
            Powerful AI Features That Transform Your Marketing
          </h3>
          <p className="text-center text-navy-400 mb-12 max-w-2xl mx-auto font-medium">
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="w-6 h-6 bg-navy-600 rounded-full flex items-center justify-center text-white font-bold text-xs">
                      {index + 1}
                    </div>
                  </div>
                  <h4 className="text-xl font-extrabold text-navy-600 mb-3">
                    {feature.title}
                  </h4>
                  <p className="text-navy-400 leading-relaxed mb-4 text-sm font-medium">
                    {feature.description}
                  </p>
                  <div className="flex items-start gap-2 text-xs font-bold text-white bg-navy-600 border-2 border-navy-600 p-3 rounded-lg shadow-sm">
                    <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5 text-gold-400" />
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-2 text-navy-600 font-bold bg-gold-100 border-2 border-gold-500 px-6 py-3 rounded-lg shadow-md">
            ...
            {contentTypes.map((item, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <h4 className="text-xl font-extrabold text-navy-600 mb-4">
                    {item.title}
                  </h4>
