...
export default function SocialProof() {
  ...
  return (
    <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24 bg-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 lg:mb-20">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gold/50 border border-gold/60 shadow-sm mb-4">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="flex-grow">
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-gold text-gold drop-shadow-sm" />
                  ))}
                </div>

                <Quote className="w-8 h-8 text-gold/60 drop-shadow-md mb-4" />
              ...
              <div className="pt-6 border-t border-gray-100 mt-auto">
                ...
                <div className="mt-4 inline-flex items-center gap-2 px-3 py-1 bg-gold/20 border border-gold/30 rounded-full text-xs font-semibold text-charcoal shadow-sm">
