        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 text-gray-700 font-medium leading-relaxed">
              With 14 years in public-sector leadership and a successful real estate career,
              Kevin founded Urban Nest to solve the marketing gap for agents—creating authentic,
              hyper-local content without sacrificing client time.
            </p>
          </div>
        </div>
      </div>
