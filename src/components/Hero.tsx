...
export default function Hero({ onGetStarted }: HeroProps) {
  ...
  return (
    <section className="relative px-4 pt-8 pb-16 sm:px-6 lg:px-8 lg:pt-16 lg:pb-24 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 bg-white/92 pointer-events-none"></div>
      <div className="absolute inset-0 bg-gradient-to-br from-white/98 via-cream-50/96 to-white/97 pointer-events-none"></div>
    ...
    In 5 Minutes a Week.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <button
              ...
              className="w-full sm:w-auto border-2 border-navy-500 text-navy-500 font-bold px-8 py-4 rounded-lg transition-all duration-300 hover:bg-navy-500 hover:text-white text-lg"
            >
              See How It Works
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 max-w-5xl mx-auto mb-8">
            <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-md border-2 border-cream-300">
              <div className="w-8 h-8 rounded-full bg-gold-500 border-2 border-gold-600 flex items-center justify-center shadow-md">
                <TrendingUp className="w-4 h-4 text-white" />
              </div>
              <span className="text-xs font-bold text-navy-600 text-center">Hyper-Local Engine</span>
            </div>
            <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-md border-2 border-cream-300">
              <div className="w-8 h-8 rounded-full bg-gold-500 border-2 border-gold-600 flex items-center justify-center shadow-md">
              ...
              <span className="text-xs font-bold text-navy-600 text-center">Google AI Suite</span>
            </div>
            <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-md border-2 border-cream-300">
              <div className="w-8 h-8 rounded-full bg-gold-500 border-2 border-gold-600 flex items-center justify-center shadow-md">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>
              </div>
              <span className="text-xs font-bold text-navy-600 text-center">Brand Customization</span>
            </div>
            <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-md border-2 border-cream-300">
              <div className="w-8 h-8 rounded-full bg-gold-500 border-2 border-gold-600 flex items-center justify-center shadow-md">
              ...
              <span className="text-xs font-bold text-navy-600 text-center">CRM Integration</span>
            </div>
            <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-md border-2 border-cream-300">
              <div className="w-8 h-8 rounded-full bg-gold-500 border-2 border-gold-600 flex items-center justify-center shadow-md">
                <Clock className="w-4 h-4 text-white" />
              </div>
              <span className="text-xs font-bold text-navy-600 text-center">Listing Automation</span>
            </div>
            <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-md border-2 border-cream-300">
              <div className="w-8 h-8 rounded-full bg-gold-500 border-2 border-gold-600 flex items-center justify-center shadow-md">
                <Users className="w-4 h-4 text-white" />
              </div>
              <span className="text-xs font-bold text-navy-600 text-center">Digital Avatar</span>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 justify-center items-center text-sm text-navy-400 font-medium">
          ...
          <p className="mt-6 text-xs text-navy-300 font-medium">
